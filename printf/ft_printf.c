...
/*   Updated: 2021/11/25 20:45:11 by rtwitch          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_type(const char s, va_list *ap, int *j)
{
	if (s == 'c')
		...
		ft_putnbr_u(va_arg(*ap, unsigned int), j);
	else if (s == 'p')
...
//  	my_f = ft_printf("%%%c%%%s%%%d%%%i%%%u%%%x%%%X%%%%", 'A', "42", 42, 42 ,42 , 42, 42);
//  	orig = printf("%%%c%%%s%%%d%%%i%%%u%%%x%%%X%%%%", 'A', "42", 42, 42 ,42 , 42, 42);
//  	printf("\nmy_f: %d\norig: %d", my_f, orig);
//  	return 0;
// }